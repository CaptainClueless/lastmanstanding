SWEP.PrintName			= "Small Prop Sprayer" -- This will be shown in the spawn menu, and in the weapon selection menu
...
SWEP.Instructions		= "Left mouse to fire a small prop"
...
function SWEP:ThrowChair( model_file )
	...
	if phys:GetMass() > MaxMass then
 	...
 	print(model_file.."has a mass of ".. phys:GetMass())
	...
	aimvec:Mul( math.random(40000, 50000) )
