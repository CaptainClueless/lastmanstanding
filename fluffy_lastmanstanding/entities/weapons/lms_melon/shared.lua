SWEP.PrintName			= "Melon Weapon" -- This will be shown in the spawn menu, and in the weapon selection menu
...
SWEP.Instructions		= "Left mouse to rain melon hell fire"
...
function SWEP:ThrowChair( model_file )
	...
	--We dont clear the melon as it probably broke up on impact
