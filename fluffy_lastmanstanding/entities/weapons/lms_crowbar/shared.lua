SWEP.PrintName			= "Crowbar Weapon" -- This will be shown in the spawn menu, and in the weapon selection menu
...
SWEP.Instructions		= "Left mouse to fire a crowbar"
...
function SWEP:PrimaryAttack()
	...
	self:ThrowChair( "models/weapons/w_crowbar.mdl" )
end
